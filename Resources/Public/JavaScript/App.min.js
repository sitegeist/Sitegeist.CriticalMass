  ...
  _createClass(Collection, [{
    ...
    value: function createNode() {
      ...
      this.dic.SharedScope.expect('Sitegeist.NeosBackendBridge:Controller.Modal').then(function (Modal) {
        _this.modalView || (_this.modalView = require('./Views/Modal.jsx').Component);
        var modal = new Modal(_this.modalView);
      ...
      }).then(function (NeosServiceAPI) {})['catch'](function (reason) {
  ...
  _createClass(FooterPanelView, [{
    ...
    value: function render() {
      return React.createElement(
        'button',
        { onClick: this.handleClickOnCreate },
        'Create New Entry'
      );
    }
  }, {
...
var ModalView = (function (_React$Component) {
  ...
  _createClass(ModalView, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        { "class": "sgcm-createNodePrompt" },
        React.createElement("input", { type: "text", name: "title", placeholder: "Enter title...", onChange: this.handleChange }),
        React.createElement(
          "footer",
          null,
          React.createElement(
            "button",
            { "class": "btn", onClick: this.handleCancel },
            "Cancel"
          ),
          React.createElement(
            "button",
            { "class": "btn", onClick: this.handleSave },
            "Save"
          )
        )
      );
