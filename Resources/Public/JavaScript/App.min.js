...
var appParser = new ComponentDomParser({
...
document.addEventListener('DOMContentLoaded', function () {
  return appParser.parse();
});
document.addEventListener('Neos.PageLoaded', function () {
  return appParser.parse();
});

},{"./Apps/Collection/App":2,"componentdomparser":6}],2:[function(require,module,exports){
'use strict';
...
var Collection = (function () {
  function Collection(el, dic) {
    ...
    this.dic.SharedScope.expect('Sitegeist.NeosBackendBridge:Controller.FooterPanel').then(this.initializeFooterPanel.bind(this));

    [].forEach.call(this.el.querySelectorAll('input[data-namespace="Sitegeist.CriticalMass:Collection"]'), function (input) {
      if (input.dataset.key && input.value) {
        _this[input.dataset.key] = input.value;
      }
    });
  }

  _createClass(Collection, [{
    key: 'initializeFooterPanel',
    value: function initializeFooterPanel(footerPanel) {
    ...
    value: function createNode() {
      ...
      var data = undefined;
      this.dic.SharedScope.expect('Sitegeist.NeosBackendBridge:Controller.Modal').then(function (Modal) {
        // Open Modal Dialog
        modalView || (modalView = require('./Views/Modal.jsx').Component);
        return Modal.prompt('Create new Entry', modalView);
      }).then(function (result) {
        // When there is a modal result, try to load NeosServiceAPI
        data = result;
        return _this2.dic.SharedScope.expect('TYPO3.Neos:NeosServiceAPI');
      }).then(function (NeosServiceAPI) {
        // With NeosServiceAPI: Create node
        return NeosServiceAPI.createNode(_this2.referenceNode, {
          nodeType: _this2.nodeType,
          properties: data
        }, _this2.insertPosition || 'into');
      }).then(function (result) {
        // if everything is in place, redirect to the resulting page
...
module.exports = function bootstrap() {
  var dic = arguments[0] === undefined ? {} : arguments[0];
...
},{"./Views/FooterPanel.jsx":3,"./Views/Modal.jsx":4,"pflibs--shared-scope":7,"react":162}],3:[function(require,module,exports){
"use strict";
...
var FooterPanelView = (function (_React$Component) {

  /**
   * @constructor
   */

  function FooterPanelView() {
    _classCallCheck(this, FooterPanelView);

    _get(Object.getPrototypeOf(FooterPanelView.prototype), "constructor", this).call(this);
    this.handleClickOnCreate = this.handleClickOnCreate.bind(this);
  }

  _inherits(FooterPanelView, _React$Component);

  _createClass(FooterPanelView, [{
    key: "getDefaultProps",
    ...
    value: function render() {
      return React.createElement(
        "button",
        { className: "sgbbtn neos", onClick: this.handleClickOnCreate },
        React.createElement("i", { className: "icon icon-plus" }),
        " Create New Entry"
      );
    }
  }, {
    key: "handleClickOnCreate",

    /**
     * @return {void}
     */
    value: function handleClickOnCreate() {
...
module.exports = {
   ...
   */
  Element: function Element(controller) {
    var element = React.createElement(FooterPanelView, {
...
var ModalView = (function (_React$Component) {
  function ModalView() {
    ...
    _get(Object.getPrototypeOf(ModalView.prototype), "constructor", this).call(this);
  ...
  _createClass(ModalView, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        { className: "sgcm-createNodePrompt u-cf" },
        "Please Enter a title for your new entry.",
        React.createElement("input", { className: "sgbtextInput", type: "text", name: "title", placeholder: "Enter title...", onChange: this.handleChange }),
        React.createElement(
          "footer",
          null,
          React.createElement(
            "button",
            { className: "sgbbtn sgbbtn--positive u-floatRight", onClick: this.handleSave },
            "Save"
          ),
          React.createElement(
            "button",
            { className: "sgbbtn u-floatLeft", onClick: this.handleCancel },
            "Cancel"
          )
        )
      );
